...
const cacheName = 'FixitLevelUp3IanOgea-2020-11-21 16:25:30.421825'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'FixitLevelUp3IanOgea'.length) === 'FixitLevelUp3IanOgea') {
